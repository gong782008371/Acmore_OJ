...
<div class="am-g">
	<div class="am-u-lg-8 am-u-sm-9 am-u-sm-centered">
		<h2 align="center">Update Problem</h2>
		<hr>
		...
		<form class="am-form" onsubmit="return oncheck()" action="<?php echo base_url()?>index.php/admin/problem/add_problem" method="post" >
			...
			<td><input style="width:100%;" name="title" id="title"/ value="<?php echo $problem['p_title'];?>"></td></tr>
			
			<tr><td><label class="text">Author</label></td>
			<td><input style="width:100%;" name="author" id="author" value="<?php echo $problem['p_author'];?>"/></td></tr>
			
			<tr><td><label class="text">Time Limit</label></td>
			<td>
				<input style="width:25%;" value="1" name="other_time_limit" id="other_time_limit" value="<?php echo $problem['p_time_other'];?>"/>
				<span style="font-family:Courier New;">S</span>
				
				<label align="right" style="width:35%;" class="text">Memory Limit</label>
				<input style="width:25%;" value="32" name="other_memory_limit" id="other_memory_limit" value="<?php echo $problem['p_mem_other'];?>"/>
				<span style="font-family:Courier New;">MB</span>
			</td></tr>
			
			<tr><td width="100px"><label class="text">Java Time</label></td>
			<td>
				<input style="width:25%;" value="2" name="java_time_limit" id="java_time_limit" value="<?php echo $problem['p_time_java'];?>"/>
				<span style="font-family:Courier New;">S</span>
				
				<label align="right" style="width:35%;" class="text">Java Memory</label>
				<input style="width:25%;" value="64" name="java_memory_limit" id="java_memory_limit" value="<?php echo $problem['p_mem_java'];?>"/>
				<span style="font-family:Courier New;">MB</span>
			</td></tr>
			</table>
			
			<label class="text">Description</label><br>
			<textarea rows="7" style="width:100%" name="description" id="description"><?php echo $problem['p_desciption'];?></textarea>

			<label class="text">Input</label><br>
			<textarea rows="7" style="width:100%" name="input" id="input"><?php echo $problem['p_input'];?></textarea>

			<label class="text">Output</label><br>
			<textarea rows="7" style="width:100%" name="output" id="output"><?php echo $problem['p_output'];?></textarea>

			<label class="text">Sample Input</label><br>
			<textarea rows="5" style="width:100%" name="sample_input" id="sample_input"><?php echo $problem['p_sam_input'];?></textarea>

			<label class="text">Sample Output</label><br>
			<textarea rows="5" style="width:100%" name="sample_output" id="sample_output"><?php echo $problem['p_sam_output'];?></textarea><br>
